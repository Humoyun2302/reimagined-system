              ...
              <Card className="overflow-hidden">
                <CardContent className="p-0">
                  <div className="p-4 bg-gradient-to-r from-blue-50 to-emerald-50 dark:from-blue-900/20 dark:to-emerald-900/20">
                    ...
                    {barberProfile.workplaceAddress && (
                      <div className="flex items-start gap-2 mb-3">
                        <MapPin className="w-4 h-4 flex-shrink-0 mt-0.5 text-[#5B8CFF]" />
                        <p className="text-sm text-gray-700 dark:text-gray-300">{barberProfile.workplaceAddress}</p>
                      </div>
                    )}
                  </div>
                  {/* Yandex Map Preview */}
                  <div className="p-3">
                    <YandexMapPreview
                      coordinates={barberProfile.workplaceCoordinates}
                      barberName={barberProfile.name}
                      address={barberProfile.workplaceAddress}
                    />
                  </div>
                </CardContent>
              </Card>
