...
import { X, Shield, Lock, Users, FileText, Database, Wrench, Globe, Share2, UserCheck, Clock } from 'lucide-react';
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
              <div className="flex-shrink-0 w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-[#5B8CFF] to-blue-600 flex items-center justify-center shadow-md">
                <Shield className="w-4.5 h-4.5 sm:w-5 sm:h-5 text-white" />
              </div>
